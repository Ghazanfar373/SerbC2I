...
namespace MissionPlanner.Controls
{
    public partial class RelayOptions : UserControl
    {
        ...
        private void BUT_Low_Click(object sender, EventArgs e)
        {
            try
            {
                if (MainSerb.comPort.doCommand((byte)MainSerb.comPort.sysidcurrent, (byte)MainSerb.comPort.compidcurrent, MAVLink.MAV_CMD.DO_SET_RELAY, thisrelay, 0, 0, 0,
                    0, 0, 0))
                {
        ...
        private void BUT_High_Click(object sender, EventArgs e)
        {
            try
            {
                if (MainSerb.comPort.doCommand((byte)MainSerb.comPort.sysidcurrent, (byte)MainSerb.comPort.compidcurrent, MAVLink.MAV_CMD.DO_SET_RELAY, thisrelay, 1, 0, 0,
                    0, 0, 0))
                {
