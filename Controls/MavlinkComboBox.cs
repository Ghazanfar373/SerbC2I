        ...
        void MavlinkComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_source != null)
            {
                try
                {
                    ...
                    if (!MainSerb.comPort.setParam((byte)MainSerb.comPort.sysidcurrent, (byte)MainSerb.comPort.compidcurrent, ParamName, (float)(Int32)Enum.Parse(_source, this.Text)))
                    {
                    ...
                    {
                        if (
                            !MainSerb.comPort.setParam((byte)MainSerb.comPort.sysidcurrent, (byte)MainSerb.comPort.compidcurrent, paramname2,
            ...
            else if (_source2 != null)
            {
                try
                {
                    ...
                    if (!MainSerb.comPort.setParam((byte)MainSerb.comPort.sysidcurrent, (byte)MainSerb.comPort.compidcurrent, ParamName, (float)(int)((MavlinkComboBox)sender).SelectedValue))
                    {
