...
namespace MissionPlanner.Controls
{
    public partial class DevopsUI : UserControl
    {
        ...
        private void but_doit_Click(object sender, EventArgs e)
        {
            ...
            MainSerb.comPort.device_op(Convert.ToByte(num_sysid.Text), Convert.ToByte(num_compid.Text), out buffer, 
        ...
        private void but_test_Click(object sender, EventArgs e)
        {
            ...
            MainSerb.comPort.device_op(1, 1, out buffer, MAVLink.DEVICE_OP_BUSTYPE.SPI, txt_spiname.Text, 0, 0, 0xff, 2, new byte[] { 0x72, 0x00 });

            MainSerb.comPort.device_op(1, 1, out buffer, MAVLink.DEVICE_OP_BUSTYPE.SPI, txt_spiname.Text, 0, 0, 0xff, 2);
